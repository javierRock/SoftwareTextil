...
def test_api_crea_consulta_lista_y_actualiza_categoria(cliente_admin) -> None:
...
def test_api_rechaza_categoria_invalida_sin_persistirla(cliente_admin) -> None:
    cliente, _ = cliente_admin
...
def test_api_controla_categoria_inexistente(cliente_admin) -> None:
    cliente, _ = cliente_admin
...
def test_api_no_elimina_categoria_referenciada_por_una_prenda(cliente_admin) -> None:

...
| `pytest tests/release/test_release.py -q`                          | 12 pruebas aprobadas.                                                                        |
...
aviso, las pruebas, ESLint y el build Vite finalizaron correctamente.
No se ejecutó `npm audit fix` porque actualizar dependencias sin revisión excede el
alcance.
